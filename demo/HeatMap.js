...
WebGLCanvas.createTplCanvas = function (cfg, data) {
  ...
  // 程序对象的生成和连接
  var programNode = (tplCanvas.glObj.programNode = create_program(
    gl,
    v_shader,
    f_shader
  ));
  ...
  var resolutionLocation = (tplCanvas.glObj.resolutionLocation =
    gl.getUniformLocation(programNode, "u_resolution"));

  var centerLocation = (tplCanvas.glObj.centerLocation = gl.getAttribLocation(
    programNode,
    "a_center"
  ));
  var radiusLocation = (tplCanvas.glObj.radiusLocation = gl.getAttribLocation(
    programNode,
    "a_radius"
  ));
  var a_clickLocation = (tplCanvas.glObj.a_clickLocation = gl.getAttribLocation(
    programNode,
    "a_click"
  ));

  var u_maxClickLocation = (tplCanvas.glObj.u_maxClickLocation =
    gl.getUniformLocation(programNode, "u_maxClick"));
  var u_minClickLocation = (tplCanvas.glObj.u_minClickLocation =
    gl.getUniformLocation(programNode, "u_minClick"));
  var u_filterClickLocation = (tplCanvas.glObj.u_filterClickLocation =
    gl.getUniformLocation(programNode, "u_filterClick"));
  ...
  function draw() {
    ...
    // 程序对象的生成和连接
    var programNode1 = (tplCanvas.glObj.programNode1 = create_program(
      gl,
      v_shader1,
      f_shader1
    ));
